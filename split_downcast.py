...
fullpath = r'C:\FieldTrips\KISSME2017\VMP experiment\UWA_036.p'
...
for n in range(0, n_casts):
    ...
    plt.plot(output['sh1']['data_physical'][keep_fast][cast_start_fast[n]:cast_stop_fast[n]], 
             output['P_fast']['data_physical'][keep_fast][cast_start_fast[n]:cast_stop_fast[n]], 'r')
    ...
    plt.plot(output['Incl_X']['data_physical'][keep_slow][cast_start_slow[n]:cast_stop_slow[n]], 
             output['P_slow']['data_physical'][keep_slow][cast_start_slow[n]:cast_stop_slow[n]], 'r')
